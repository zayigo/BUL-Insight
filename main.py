...
for file_name in pdf_files:
    ...
    for section_title, tables_info in section_tables.items():
        ...
        for table_info in tables_info:
            table = table_info[2]  # Extract the DataFrame from the tuple
            ...
            if categories and (current_category is None or regions_found == 20):
                ...
                regions_found = 0
                print(f"Processing category: {current_category.name}")
            elif not categories:
                break
            ...
            if (file_name in {'2022_06.pdf', '2022_07.pdf', '2022_08.pdf', '2022_09.pdf'}  #
            ...
            try:
                regions_found += doc_parser.process_table(table, columns, date_str, current_category)
